...
void bind_genesis_utils_formats_nexus_writer(std::function< pybind11::module &(std::string const &namespace_) > &M)
{
	...
	// genesis::utils::ranking_standard(const class std::vector<double, class std::allocator<double> > &) file:genesis/utils/math/ranking.hpp line:91
	...
	// genesis::utils::ranking_modified(class __gnu_cxx::__normal_iterator<const double *, class std::vector<double, class std::allocator<double> > >, class __gnu_cxx::__normal_iterator<const double *, class std::vector<double, class std::allocator<double> > >) file:genesis/utils/math/ranking.hpp line:110
	...
	// genesis::utils::ranking_modified(const class std::vector<double, class std::allocator<double> > &) file:genesis/utils/math/ranking.hpp line:149
	...
	// genesis::utils::ranking_dense(class __gnu_cxx::__normal_iterator<const double *, class std::vector<double, class std::allocator<double> > >, class __gnu_cxx::__normal_iterator<const double *, class std::vector<double, class std::allocator<double> > >) file:genesis/utils/math/ranking.hpp line:167
	...
	// genesis::utils::ranking_dense(const class std::vector<double, class std::allocator<double> > &) file:genesis/utils/math/ranking.hpp line:199
	...
	// genesis::utils::ranking_ordinal(class __gnu_cxx::__normal_iterator<const double *, class std::vector<double, class std::allocator<double> > >, class __gnu_cxx::__normal_iterator<const double *, class std::vector<double, class std::allocator<double> > >) file:genesis/utils/math/ranking.hpp line:217
	...
	// genesis::utils::ranking_ordinal(const class std::vector<double, class std::allocator<double> > &) file:genesis/utils/math/ranking.hpp line:240
	...
	// genesis::utils::ranking_fractional(class __gnu_cxx::__normal_iterator<const double *, class std::vector<double, class std::allocator<double> > >, class __gnu_cxx::__normal_iterator<const double *, class std::vector<double, class std::allocator<double> > >) file:genesis/utils/math/ranking.hpp line:260
	...
	// genesis::utils::ranking_fractional(const class std::vector<double, class std::allocator<double> > &) file:genesis/utils/math/ranking.hpp line:319

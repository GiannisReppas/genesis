...
{
	// genesis::utils::resolve_color_string(const std::string &) file:genesis/utils/tools/color/functions.hpp line:97
	...
	// genesis::utils::interpolate(const class genesis::utils::Color &, const class genesis::utils::Color &, double) file:genesis/utils/tools/color/functions.hpp line:106
	...
	// genesis::utils::gradient(const class std::map<double, class genesis::utils::Color, struct std::less<double>, class std::allocator<struct std::pair<const double, class genesis::utils::Color> > > &, double) file:genesis/utils/tools/color/functions.hpp line:139
	...
	// genesis::utils::heat_gradient(double) file:genesis/utils/tools/color/functions.hpp line:148

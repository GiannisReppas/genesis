...
void bind_genesis_utils_math_bitvector(std::function< pybind11::module &(std::string const &namespace_) > &M)
{
	...
	extend_matrix_operations(M("genesis::utils"));
	...
	{ // genesis::utils::BitvectorHash file:genesis/utils/math/bitvector.hpp line:422
	...
	{ // genesis::utils::BitvectorXhash file:genesis/utils/math/bitvector.hpp line:445

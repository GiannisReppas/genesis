...
if 7 != leaf_node_count(tree):
	print("Error at DISTANCES-1")
if 6 != inner_node_count(tree):
	print("Error at DISTANCES-2")
if 13 != tree.node_count():
	print("Error at DISTANCES-3")
if not is_bifurcating( tree ):
	print("Error at DISTANCES-4")
if not validate_topology( tree ):
	print("Error at DISTANCES-5")
...
if not (exp == edge_branch_length_distance_matrix(tree)):
	print("Error at DISTANCES-6")
if exp != edge_branch_length_distance_matrix(tree):
	print("Error at DISTANCES-7")
...
if exp != mat:
	print("Error at PATRISTIC_DISTANCES-1")
if 3100.0 != diameter(tree):
	print("Error at PATRISTIC_DISTANCES-2")
